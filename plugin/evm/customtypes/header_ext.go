...
// see https://github.com/MetalBlockchain/coreth/pull/746#discussion_r1969673252
...
//go:generate go run github.com/MetalBlockchain/libevm/rlp/rlpgen -type HeaderSerializable -out gen_header_serializable_rlp.go
