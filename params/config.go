...
func (c *ChainConfig) String() string {
	...
	banner += fmt.Sprintf(" - Blueberry Timestamp:              %-8v (https://github.com/MetalBlockchain/metalgo/releases/tag/v1.9.0)\n", c.BlueberryBlockTimestamp)
	banner += fmt.Sprintf(" - Clementine Timestamp:             %-8v (https://github.com/MetalBlockchain/metalgo/releases/tag/v1.10.0)\n", c.ClementineBlockTimestamp)
	banner += "\n"
	return banner
}
