...
var (
	...
	MetalMainnetChainConfig = &ChainConfig{
		...
		CortinaBlockTimestamp:           big.NewInt(time.Date(2023, time.August, 17, 10, 0, 0, 0, time.UTC).Unix()),
		// TODO Add DUpgrade timestamp
	}
	...
	MetalTahoeChainConfig = &ChainConfig{
		...
		CortinaBlockTimestamp:           big.NewInt(time.Date(2023, time.June, 28, 15, 0, 0, 0, time.UTC).Unix()),
		// TODO Add DUpgrade timestamp
	}
