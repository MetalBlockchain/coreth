...
import (
	...
	tracers2 "github.com/MetalBlockchain/coreth/eth/tracers"
	"github.com/MetalBlockchain/coreth/eth/tracers/js/internal/tracers"
...
func (t *jsTracer) CaptureEnd(output []byte, gasUsed uint64, time time.Duration, err error) {
	t.ctx["output"] = t.vm.ToValue(output)
	t.ctx["time"] = t.vm.ToValue(time.String())
